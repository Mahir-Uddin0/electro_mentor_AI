  ...
  return (
    <>
      ...
      <div className="page-heading">
        <div>
          <Badge tone="blue">House Wiring</Badge>
          <h1 style={{ marginTop: 8 }}>House Wiring Safety Checklist</h1>
          <p>Essential safety checks before, during, and after house wiring installation.</p>
        </div>
      </div>

      <Card className="generator-card">
        <div style={{ display: "flex", justifyContent: "space-between", gap: 12, marginBottom: 9 }}>
          <strong style={{ fontSize: 11 }}>Progress</strong>
          <span style={{ color: "var(--muted)", fontSize: 11 }}>{checked.size} / {checklistItems.length} completed</span>
        </div>
      ...
      <Card>
        <div className="checklist-items">
          <h2 style={{ display: "flex", alignItems: "center", gap: 8, margin: "0 0 12px", fontSize: 15 }}>
            <CheckCircle2 size={18} color="var(--green)" /> Checklist Items
          </h2>
      ...
      <div style={{ marginTop: 14 }}>
        <Card className="detail-section">
          <h2><ShieldCheck size={18} color="var(--green)" /> PPE Required</h2>
          <div className="chips">
            <Badge tone="green"><HardHat size={12} /> Insulated Gloves</Badge>
            <Badge tone="green"><HardHat size={12} /> Safety Shoes</Badge>
            <Badge tone="green"><HardHat size={12} /> Safety Goggles</Badge>
            <Badge tone="green"><HardHat size={12} /> Fire Extinguisher</Badge>
          </div>
        </Card>
      </div>
      ...
      <div style={{ marginTop: 14 }}>
        <Card className="detail-section">
          <h2><AlertTriangle size={18} color="var(--red)" /> Emergency Procedures</h2>
          <div style={{ display: "grid", gap: 8 }}>
            <div className="alert alert-red"><AlertTriangle size={16} /><p>In case of electric shock: Disconnect power immediately, call emergency services</p></div>
            <div className="alert alert-red"><Flame size={16} /><p>In case of fire: Use CO2 or dry chemical extinguisher, never water</p></div>
            <div className="alert alert-red"><ShieldCheck size={16} /><p>First aid kit location: Workshop entrance</p></div>
          </div>
        </Card>
      </div>
    </>
